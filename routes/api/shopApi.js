...
//seller
router.get(
  "/statistics/chart/revenue",
  mdJWT.api_shop_auth,
  ShopApiCtrl.statisticsChartRevenue
);
router.get(
  "/statistics/chart/sold",
  mdJWT.api_shop_auth,
  ShopApiCtrl.statisticsChartSold
);
router.get(
  "/statistics/year/revenue",
  mdJWT.api_shop_auth,
  ShopApiCtrl.statisticsYearRevenue
);
router.get(
  "/statistics/year/sold",
  mdJWT.api_shop_auth,
  ShopApiCtrl.statisticsYearSold
);
...
router.get(
  ...
  mdJWT.api_shop_auth,
  ShopApiCtrl.listProcessBill
);
router.get(
  "/list/bill/delivering",
  mdJWT.api_shop_auth,
  ShopApiCtrl.listDeliveringBill
);
router.get(
  "/list/bill/delivered",
  mdJWT.api_shop_auth,
  ShopApiCtrl.listDeliveredBill
);
router.get(
  "/list/bill/evaluated",
  mdJWT.api_shop_auth,
  ShopApiCtrl.listEvaluatedBill
);
router.get(
  "/list/bill/cancelled",
  mdJWT.api_shop_auth,
  ShopApiCtrl.listCancelledBill
);
router.get(
  "/list/appointment",
  mdJWT.api_shop_auth,
  ShopApiCtrl.listAppointment
);
router.get("/pet/detail/:idPet", mdJWT.api_shop_auth, ShopApiCtrl.detailPet);
router.get(
  "/product/detail/:idProd",
  mdJWT.api_shop_auth,
  ShopApiCtrl.detailProduct
);
router.get(
  "/appointment/detail/:idAppt",
  mdJWT.api_shop_auth,
  ShopApiCtrl.detailAppointment
);
router.post("/bill/confirm", mdJWT.api_shop_auth, ShopApiCtrl.confirmBill);
router.post(
  "/bill/confirmAll",
  mdJWT.api_shop_auth,
  ShopApiCtrl.confirmBillAll
);
...
router.put(
  "/update/:idShop",
  [mdJWT.api_shop_auth, uploader.single("avatarShop")],
  ShopApiCtrl.editShop
);
