...
function encodeName(name) {
    // let encode = name.substring(0, 1)
    //     + removeVietnameseTones(name.substring(1, name.length - 1))
    //         .replace(/[a-zA-Z]/g, '*')
...
module.exports = {
    encodeToSha256, decodeFromSha256,
    encodeToAscii, decodeFromAscii,
    removeVietnameseTones, encodeName
};